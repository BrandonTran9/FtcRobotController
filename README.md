...
Known issues:
* org.firstinspires.ftc.teamcode.Eli_Auto complete function is incomplete and does not support the following (for now):
 ...
 * Includes Block programming improvements
    ...
    - org.firstinspires.ftc.teamcode.Eli_Auto scrollbar to projects and sounds pages.
